...
const Register = () => {
    ...
    if(loading){
        return (<main className={authMainClass}><Loader text="Creating your account..." /></main>)
    }
        ...
        <main className={authMainClass}>
            <div className={formCardClass}>
                <div className="mb-2 text-center">
                    <h1 className="mb-2 text-[1.75rem] font-bold text-[#e6edf3]">Get Started</h1>
                    <p className="m-0 text-sm text-[#7d8590]">Create your AI Interview Prep account</p>
                </div>
                ...
                <p className="m-0 text-center text-sm text-[#7d8590]">Already have an account? <Link className="font-semibold text-[#ff2d78] transition hover:text-[#ff6b9d] hover:underline" to={"/login"} >Login</Link> </p>
            </div>
        </main>
    )
}
